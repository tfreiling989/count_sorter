...
# Node and DoublyLinkedList FROM https://favtutor.com/blogs/doubly-linked-list-python
class Node:
...
class DoublyLinkedList:
    def __init__(self):
        self.head: Optional[Node] = None  # Initally there are no elements in the list
